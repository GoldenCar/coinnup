...
//    }
    ...
    public ImageView getItem(int position) {
        return mBottomNavigationTabs.get(position).iconView;
    }
    ...
    public void initialise() {
        ...
        if (!mBottomNavigationItems.isEmpty()) {
            ...
            if (mMode == MODE_FIXED || mMode == MODE_FIXED_NO_TITLE) {
                ...
                // Make center icon bigger  then the other
                for (int i = 0; i < mBottomNavigationItems.size(); i++) {
                    ...
                    if (i == 2) {
                        bottomNavigationTab.iconView.getLayoutParams().width = convertPixelsToDp(41);
                        bottomNavigationTab.iconView.getLayoutParams().height = convertPixelsToDp(41);
                    }
                    setUpTab(mMode == MODE_SHIFTING_NO_TITLE, bottomNavigationTab, mBottomNavigationItems.get(i), itemWidth, itemActiveWidth);
                }
            }
    ...
    private void setUpTab(boolean isNoTitleMode, BottomNavigationTab bottomNavigationTab, BottomNavigationItem currentItem, int itemWidth, int itemActiveWidth) {
        ...
        bottomNavigationTab.initialise(mBackgroundStyle == BACKGROUND_STYLE_STATIC, mBottomNavigationTabs.size() != 3);
